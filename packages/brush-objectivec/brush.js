...
function Brush() {
  ...
  this.regexList = [
    { regex: regexLib.singleLineCComments, css: 'comments color5 italic' }, // one line comments
    { regex: regexLib.multiLineCComments, css: 'comments color5 italic' }, // multiline comments
    { regex: regexLib.doubleQuotedString, css: 'string color9' }, // strings
    { regex: regexLib.singleQuotedString, css: 'string color9' }, // strings
