...
const sh = {
  ...
  findElements: function (globalParams, element) {
    var elements = element
        ? [element]
        : utils.toArray(document.getElementsByTagName(sh.config.tagName)),
      result = [];
   ...
   *              are highlighted.
   */
  highlight: function (globalParams, highlightedElement) {
    var elements = sh.findElements(globalParams, highlightedElement),
...
export const registerBrush = (brush) =>
  (sh.brushes['brush' + brushCounter++] = brush.default || brush);
